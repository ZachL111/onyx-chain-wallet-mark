...
onyx-chain-wallet-mark is a C project for blockchain tooling. It focuses on this technical goal: Implement a C blockchain tooling project for wallet resource planning, using capacity fixtures and allocation and spill reports.
